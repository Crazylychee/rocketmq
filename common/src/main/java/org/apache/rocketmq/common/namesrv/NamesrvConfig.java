...
public class NamesrvConfig {
    ...
    private String kvConfigPath = System.getenv().getOrDefault("ROCKETMQ_BROKER_STORE_PATH", System.getProperty("user.home")) + File.separator + "namesrv" + File.separator + "kvConfig.json";
    private String configStorePath = System.getenv().getOrDefault("ROCKETMQ_BROKER_STORE_PATH", System.getProperty("user.home")) + File.separator + "namesrv" + File.separator + "namesrv.properties";
